      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-foreground mb-4">
            Request a Free ICT Consultation Today
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Ready to transform your business with professional ICT solutions? 
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Our team is ready to help you with all your ICT needs. 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="computer-sales">Computer Sales & Services</option>
                    <option value="networking">Networking & Infrastructure</option>
                    <option value="software">Software Sales & Custom Apps</option>
                    <option value="cloud-computing">Cloud Computing & Data Backup</option>
                    <option value="web-development">Web Development & Digital Marketing</option>
                    <option value="training">Corporate Training</option>
                    <option value="security">ICT Audits & Security</option>
                    <option value="emerging-tech">Emerging Solutions</option>
